...
- #### ORAL
  ...
  - [ORAL][ICML-2024] Doubly Robust Causal Effect Estimation under Networked Interference via Targeted Learning [paper](https://icml.cc/virtual/2024/oral/35570)
  
  - [ORAL][ICML-2024] Hybrid<sup>2</sup> Neural ODE Causal Modeling and an Application to Glycemic Response [paper](https://icml.cc/virtual/2024/oral/35547)
  
  - [ORAL][ICML-2024] Inferring the Long-Term Causal Effects of Long-Term Treatments from Short-Term Experiments [paper](https://icml.cc/virtual/2024/oral/35474)
  
  - [ORAL][ICML-2024] ACE: Off-Policy Actor-Critic with Causality-Aware Entropy Regularization [paper](https://icml.cc/virtual/2024/oral/35581)
  
  - [ORAL][ICLR-2024] Robust agents learn causal world models [paper](https://iclr.cc/virtual/2024/oral/19724)
  
  - [ORAL][NeurIPS-2023] Learning Linear Causal Representations from Interventions under General Nonlinear Mixing [paper](https://nips.cc/virtual/2023/oral/73823)
  
  - [ORAL][NeurIPS-2023] A Measure-Theoretic Axiomatisation of Causality [paper](https://nips.cc/virtual/2023/oral/73819)
  
  - [ORAL][NeurIPS-2023] Causal normalizing flows: from theory to practice [paper](https://nips.cc/virtual/2023/oral/73851)

  - [ORAL][ICML-2023] Interventional Causal Representation Learning [paper](https://icml.cc/virtual/2023/oral/25523)
  
  - [ORAL][ICML-2023] Returning The Favour: When Regression Benefits From Probabilistic Causal Knowledge [paper](https://icml.cc/virtual/2023/oral/25553)
  
  - [ORAL][ICLR-2023] GRACE-C: Generalized Rate Agnostic Causal Estimation via Constraints [paper](https://iclr.cc/virtual/2023/oral/12717)
  
  - [ORAL][ICLR-2023] Rhino: Deep Causal Temporal Relationship Learning with History-dependent Noise [paper](https://iclr.cc/virtual/2023/oral/12768)
  
  - [ORAL][ICLR-2023] Model-based Causal Bayesian Optimization [paper](https://iclr.cc/virtual/2023/oral/14239)
  
  - [ORAL][NeurIPS-2022] Causal Identification under Markov equivalence: Calculus, Algorithm, and Completeness [paper](https://nips.cc/virtual/2023/oral/73851)
  
  - [ORAL][NeurIPS-2022] Empirical Gateaux Derivatives for Causal Inference [paper](https://nips.cc/virtual/2022/poster/52809)
  
  - [ORAL][ICML-2022] Minimum Cost Intervention Design for Causal Effect Identification [paper](https://icml.cc/virtual/2022/oral/17380)
  
  - [ORAL][ICML-2022] Causal Dynamics Learning for Task-Independent State Abstraction [paper](https://icml.cc/virtual/2022/oral/17380)
  
  - [ORAL][ICML-2022] Score Matching Enables Causal Discovery of Nonlinear Additive Noise Models [paper](https://icml.cc/virtual/2022/oral/17380)

  - [ORAL][ICML-2022] Causal Imitation Learning under Temporally Correlated Noise [paper](https://icml.cc/virtual/2022/oral/18070)
  
  - [ORAL][ICML-2022] Causal Conceptions of Fairness and their Consequences [paper](https://icml.cc/virtual/2022/oral/17122)
  
  - [ORAL][ICLR-2021] VCNet and Functional Targeted Regularization For Learning Causal Effects of Continuous Treatments [paper](https://iclr.cc/virtual/2021/oral/3476)
  
  - [ORAL][NeurIPS-2021] Causal Identification with Matrix Equations [paper](https://neurips.cc/virtual/2021/oral/30341)
  
  - [ORAL][NeurIPS-2021] Sequential Causal Imitation Learning with Unobserved Confounders [paper](https://neurips.cc/virtual/2021/oral/30300)
  
  - [ORAL][NeurIPS-2020] Gradient Estimation with Stochastic Softmax Tricks [paper](https://nips.cc/virtual/2020/oral/18504)
...
- Differentiable Causal Discovery from Interventional Data [paper](https://papers.nips.cc/paper_files/paper/2020/file/f8b7aa3a0d349d9562b424160ad18612-Paper.pdf), code: [python](https://github.com/slachapelle/dcdi)
- Characterization and Greedy Learning of Interventional Markov Equivalence Classes of Directed Acyclic Graphs [paper](https://www.jmlr.org/papers/volume13/hauser12a/hauser12a.pdf), code [python](https://github.com/juangamella/gies)
...
- Joint Causal Inference from Multiple Contexts [paper](https://jmlr.org/papers/volume21/17-123/17-123.pdf), code: [R](https://github.com/caus-am/jci)
- DirectLiNGAM: A Direct Method for Learning a Linear Non-Gaussian Structural Equation Model [paper](https://www.jmlr.org/papers/volume12/shimizu11a/shimizu11a.pdf), code: [python](https://github.com/cdt15/lingam/blob/master/lingam/direct_lingam.py)
- CONSISTENCY GUARANTEES FOR GREEDY PERMUTATION-BASED CAUSAL INFERENCE ALGORITHMS [paper](https://arxiv.org/pdf/1702.03530), code: [R](https://github.com/yuhaow/greedy_sp)
- Permutation-Based Causal Structure Learning with Unknown Intervention Targets [paper](https://proceedings.mlr.press/v124/squires20a/squires20a.pdf), code: [python](https://github.com/csquires/utigsp)
...
- DAGs with NO TEARS: Continuous Optimization for Structure Learning [paper](https://proceedings.neurips.cc/paper_files/paper/2018/file/e347c51419ffb23ca3fd5050202f9c3d-Paper.pdf), code [python](https://github.com/xunzheng/notears)

- [tool](https://github.com/FenTechSolutions/CausalDiscoveryToolbox)
...
## Important foundations
  ...
  - ### Maths
    ...
    - #### Functional Analysis and Calculus
       - [Course](https://ocw.mit.edu/courses/18-102-introduction-to-functional-analysis-spring-2021/video_galleries/lecture-videos/) Introduction to Functional Analysis From MIT (note that you requirely have a background in Multivariable Calculus and Mathematic Analysis, which is contained in this link)  
